...
@EnableJpaRepositories(
        basePackages = "fr.numalama.demo.repository.db2",
...
public class PostgresDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean postgresDBEntityManager() {
        ...
        em.setDataSource(postgresqlDBDataSource());
    ...
    public DataSource postgresqlDBDataSource() {
        DriverManagerDataSource dataSource
                = new DriverManagerDataSource();
        dataSource.setDriverClassName(
                env.getProperty("spring.numalama.postgresql.driver-class-name")
        );
        dataSource.setUrl(
                env.getProperty("spring.numalama.postgresql.url")
        );
        dataSource.setUsername(
                env.getProperty("spring.numalama.postgresql.username")
        );
        dataSource.setPassword(
                env.getProperty("spring.numalama.postgresql.password")
        );
        return dataSource;
    }
    ...
    public PlatformTransactionManager postgresDBTransactionManager() {
        ...
        transactionManager.setEntityManagerFactory(
                postgresDBEntityManager().getObject());
